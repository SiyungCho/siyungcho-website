...
SECRET_KEY = 'django-insecure-4#g*by)o+ssr&lu(8d$s!zr@3hc5-6%j2n@01btcn(h5kn%ti!'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = False

ALLOWED_HOSTS = ['https://personal-web-app-2c5cbb72d88b.herokuapp.com/']
...
CHANNEL_LAYERS = {
    'default': {
        ...
        'CONFIG': {
            "hosts": [('127.0.0.1', 6379)],  # Or your Redis server details
        },
    },
}
